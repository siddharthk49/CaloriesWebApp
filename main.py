...
class CaloriesFormPage(MethodView):
    ...
    def post(self):
        ...
        calorie = Calorie (weight=calories_form.weight.data, height=calories_form.height.data,
                           age=calories_form.age.data,temperature=temperature)

        calories= calorie.calculate()

        return render_template('calories_form_page.html', calories_form = calories_form, calories = calories, result = True)
...
class CaloriesForm(Form):
    ...
    city = StringField("City: ", default='New Delhi')
